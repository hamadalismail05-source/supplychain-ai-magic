...
const en: Dict = {
  ...
  "hero.builtwith": "Built with clinicians from",
  ...
  "form.note": "No spam. HIPAA-aware. Unsubscribe anytime.",
  ...
  "sandbox.itemResolvedDesc": "PO Drafted: 3x Titanium Stems",
  "sandbox.run": "Run AI Resolution",
  "sandbox.running": "Resolving…",
...
const ar: Dict = {
  ...
  "hero.builtwith": "بُني مع أطباء من",
  ...
  "form.note": "بدون رسائل مزعجة. متوافق مع HIPAA. يمكنك إلغاء الاشتراك في أي وقت.",
  ...
  "sandbox.itemResolvedDesc": "أمر شراء: 3 سيقان تيتانيوم",
  "sandbox.run": "تشغيل حل الذكاء الاصطناعي",
  "sandbox.running": "جارٍ الحل…",
